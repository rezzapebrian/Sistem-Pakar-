...
if(isset($_POST['simpan'])){
	...
	$query_cid = mysqli_query($kon, "SELECT max(right(id_user, 6))+1 as rid_cid from pasien");
	...
	$simpan=mysqli_query($kon,"INSERT into pasien values ('$id_oto', '$_POST[username]','$_POST[password]','$_POST[nm_lengkap]', '$_POST[jns_kelamin]', '$_POST[alamat]', '$_POST[no_hp]', '$_POST[pekerjaan]')");
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                    <h5 class="mb-0">REGISTRASI PASIEN</h5>
