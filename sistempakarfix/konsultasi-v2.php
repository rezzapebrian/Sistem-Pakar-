								...
								if($jumlah<1){
									...
									if($jumlah>11){
										...
										for($i=0; $i < $jumlah; $i++){
											...
											$q=mysqli_query($kon,"insert into hasil_konsultasi(id_user, konsultasi, id_gejala, b1, b2, b3, b4, b5, waktu) value ('$id_user', $konsultasi, '$gejala', '$b1', '$b2', '$b3', '$b4', '$b5', NOW())") or die(mysqli_error());
