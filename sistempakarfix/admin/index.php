...
<body>
    ...
    <div class="navbar navbar-expand-md navbar-dark">
    	...
    	<div class="collapse navbar-collapse" id="navbar-mobile">
    		...
    		<ul class="navbar-nav">
    			<li class="nav-item">
    				<a href="<?php echo"?p=dokter";?>" class="navbar-nav-link">
    					<span>Dokter</span>
    				</a>
    			</li>
    			<li class="nav-item">
            ...
            <?php
                if (isset($_GET["p"])){
            		if ($_GET["p"] == "admin"){
            			...
            			include "addadminaksi.php";
            		}else if ($_GET["p"] == "editadmin"){
            			include "editadmin.php";
            		}else if ($_GET["p"] == "editadminaksi"){
            			include "editadminaksi.php";
            		}else if ($_GET["p"] == "hapusadmin"){
            			include "hapusadmin.php";
                    }else if ($_GET["p"] == "dokter"){
                        include "dokter.php";
                    }else if ($_GET["p"] == "adddokter"){
                        include "adddokter.php";
                    }else if ($_GET["p"] == "adddokteraksi"){
                        include "adddokteraksi.php";
                    }else if ($_GET["p"] == "editdokter"){
                        include "editdokter.php";
                    }else if ($_GET["p"] == "editdokteraksi"){
                        include "editdokteraksi.php";
                    }else if ($_GET["p"] == "hapusdokter"){
                        include "hapusdokter.php";
